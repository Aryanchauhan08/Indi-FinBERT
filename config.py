...
CREDIBILITY_WEIGHTS = {
    ...
    "livemint": 0.85,
    "mint": 0.85,
    "financial express": 0.82,
    "hindu business line": 0.82,
    "investing.com india": 0.78,
    "investing.com": 0.75,
    "reuters": 0.92,
    "bloomberg": 0.92,
    "pr_newswire": 0.40,
...
TICKER_KEYWORDS = {
    ...
    "ITC.NS": ["itc limited", "itc ltd", "itc fmcg", "itc cigarette", "itc hotel"],
    ...
    "LT.NS": ["larsen & toubro", "larsen toubro", "l&t infrastructure", "l&t limited"],
    ...
    "SBIN.NS": ["state bank of india", "sbi bank", "sbi results", "sbi earnings", "sbi q1", "sbi q2", "sbi q3", "sbi q4"],
